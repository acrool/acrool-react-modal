...
- Create an [issue](https://github.com/acrool/acrool-react-modal/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-react-modal/issues), assuming one does not already exist.
